REM *** Lotto 649 Package Version 2020 Working Version With Automatic Draw Date Update
REM *** Written by: Russ Campbell
REM
REM *** Last Update : December 29 - 9:00 PM
REM
...
SUB buildtitlepage
    ...
    LOCATE 6, 9
    PRINT "  Lotto 649 Package Version 2020   Finished On  Dec 29 2019  "
    LOCATE 7, 9
    PRINT " Working Version RC3  Copyright (c) 2020 Good Until Jan 2040 "
    ...
    LOCATE 11, 14
    PRINT "Release Date  : Dec 29 2019 - 9:00 PM              "
    LOCATE 12, 14
    PRINT "Registered To :                                    "
    LOCATE 12, 30
    PRINT reg$
...
SUB calculatedayofweek
    ...
    IF dayflag = 0 THEN
        ...
        IF day1 = 5 THEN day1 = 0
        IF day1 = 4 THEN day1 = 4
        IF day1 = 3 THEN day1 = 0
        IF day1 = 2 THEN day1 = 4
        IF day1 = 1 THEN day1 = 0
        IF day1 = 0 THEN day1 = 0
    ELSEIF dayflag = 1 THEN
        IF day1 = 6 THEN day8 = 0
        IF day1 = 5 THEN day8 = 0
        IF day1 = 4 THEN day8 = 4
        IF day1 = 3 THEN day8 = 0
        IF day1 = 2 THEN day8 = 4
        IF day1 = 1 THEN day8 = 0
        IF day1 = 0 THEN day8 = 0
    END IF
    RETURN
END SUB
SUB add3or4days
    ...
    IF day1 = 4 AND count = -1 THEN
        ...
        END IF
    ELSEIF day1 = 0 AND count = -1 THEN
        IF rollover = 0 THEN
            adddays = -3
            dy = dy + adddays
        ELSEIF rollover = 1 THEN
...
SUB rollover2
    ...
    IF y = 2020 THEN
        ...
        IF dy > 29 AND m = 2 THEN m = 3: dy = 4: rollover = 1: adjust = 2
        ...
        IF dy > 31 AND m = 12 THEN y = 2021: m = 1: dy = 2: rollover = 1: adjust = 0
    END IF
    IF y = 2021 THEN
...
SUB picker
    ...
    CALL start
    entry:
    IF randome$ = "yes" THEN CALL start
    CLS
    FOR zq = 1 TO qqq
...
SUB main
    ...
    IF crs$ = "Y" THEN COLOR 10, 5
    LOCATE 5, 8
    PRINT "            Lotto 649 Package Version 2020 RC2 Main Menu          "
...
SUB bartchartmenu
    IF crs$ = "Y" THEN COLOR 10, 5
    LOCATE 3, 7
    PRINT "          Lotto 649 Package Version 2020 RC2 Barchart Menu         "
    LOCATE 13, 7
...
SUB searchmenu2
    ...
    IF crs$ = "Y" THEN COLOR 10, 5
    LOCATE 4, 11
    PRINT " Lotto 649 Package Version 2020 RC2 Search and Print Menu "
    IF crs$ = "Y" THEN COLOR 4, 7
    FOR i = 6 TO 10
        LOCATE i, 17
        PRINT "["
...
SUB specialcheck
    ...
    savednumbers:
    IF saved$ = "Y" OR saved$ = "y" THEN CALL szc
...
SUB checknumbers
    ...
    FOR zqa = 1 TO 7
        ...
        ELSE
            PRINT "Entry #"; zqa; " ";: INPUT entry(zqa)
        END IF
        IF entry(zqa) = 0 THEN CALL searchmenu
...
SUB enterwinningnumbers
    ...
    PRINT
    IF count = -1 THEN PRINT "Wrong mumbers entered, please fix them !": PRINT
    enternumbers:

    PRINT
    first:
    INPUT "Enter 1st number   : ", A
    IF A = 0 THEN CLOSE #1: count = -1: CALL add3or4days: CALL main
    ...
    PRINT
    PRINT "You Have Entered: "; dayofweek$(day1); " "; month$(m); " "; dy; " "; y; " "; A; " "; b; " "; c; " "; d; " "; e; " "; f; " Bonus  :"; g

    PRINT "Is the above correct [Y]es  No  Quit [Y default] : "
    answer$ = INPUT$(1)

    IF answer$ = "" OR answer$ = "y" THEN answer$ = "Y"
    IF answer$ = "n" OR answer$ = "N" OR answer$ = "no" OR answer$ = "NO" THEN count = -1: CALL add3or4days: GOTO beginning
    IF answer$ = "Q" OR answer$ = "q" THEN CLOSE #1: CALL main
    IF answer$ = "Y" THEN
    ...
    IF answer$ = "" OR answer$ = "Y" OR answer$ = "y" THEN
        count = 1: CLOSE #1: CALL buildchart: CALL convert: CALL enterwinningnumbers
    ELSE
        CLOSE #1
        CALL buildchart
        CALL convert

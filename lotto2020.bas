REM *** Lotto 649 Package Version 2020 RC4 Working Version With Automatic Draw Date Update
REM *** Written by: Russ Campbell
REM
REM *** Last Update : January 01 220 - 01:00 AM
REM
...
LOCATE 6, 9
PRINT "  Lotto 649 Package Version 2020 With Automatic Date Update  "
LOCATE 7, 9
...
PRINT
money:
INPUT "How much money do you wish to spend [At $4.00 per sets of numbers : ]  $", sets
IF sets < 4 THEN
    PRINT "You need to spend at least $4.00 - Please try again!"
    GOTO money
END IF
sets = INT(sets / 4)
PRINT
...
IF crs$ = "Y" THEN COLOR 10, 5
LOCATE 5, 8
PRINT "            Lotto 649 Package Version 2020 RC4 Main Menu          "
...
IF crs$ = "Y" THEN COLOR 10, 5
LOCATE 3, 7
PRINT "          Lotto 649 Package Version 2020 RC4 Barchart Menu         "
LOCATE 13, 7
